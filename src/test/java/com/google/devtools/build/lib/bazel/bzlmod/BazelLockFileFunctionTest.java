...
public class BazelLockFileFunctionTest extends FoundationTestCase {
                ...
                .put(
                    ...
                    new SkyFunction() {
                      ...
                      public SkyValue compute(SkyKey skyKey, Environment env)
                        ...
                        BazelLockFileFunction.updateLockedModule(rootDirectory,
                            key.moduleHash(), flags, localOverrideHashes ,key.depGraph());
                        return new SkyValue() {};
                      }
                    })
                .buildOrThrow(),
  ...
  public void fullModule() throws Exception {
    ...
    UpdateLockFileKey key = UpdateLockFileKey.create("moduleHash", depGraph, rootValue.getOverrides());
    EvaluationResult<BazelLockFileValue> result =
        evaluator.evaluate(ImmutableList.of(key), evaluationContext);
    if (result.hasError()) {
      fail(result.getError().toString());
  ...
  abstract static class UpdateLockFileKey implements SkyKey {
    ...
    static UpdateLockFileKey create(String moduleHash, ImmutableMap<ModuleKey, Module> depGraph,
      ...
      return new AutoValue_BazelLockFileFunctionTest_UpdateLockFileKey(moduleHash, depGraph, overrides);
    }
